...
def _minimal() -> None:
    ...
    arch_config_handler.config.locale_config = locale_config
    arch_config_handler.config.archinstall_language = archinstall_language
    arch_config_handler.config.profile_config = profile_config
    arch_config_handler.config.mirror_config = mirror_config
    ...
    arch_config_handler.config.app_config = app_config
    arch_config_handler.config.auth_config = auth_config
